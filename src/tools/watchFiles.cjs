...
function autoGenerateStore() {
  ...
  const outputFilePath = path.join(
    __dirname,
    `../components/dynamic/${generatedDir}/PageStores.ts`
  );
...
function autoGenerateHandlers() {
  ...
  const outputFilePath = path.join(
    __dirname,
    `../components/dynamic/${generatedDir}/PageHandlers.ts`
  );
