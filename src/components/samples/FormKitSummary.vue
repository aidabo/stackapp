          ...
          <template #help="context">
            <div :class="[context.classes.help]">
              ...
              <span
                ...
                1000 characters remaining.</span
              >
            </div>
          </template>
        </FormKit>
...
import { FormKit, FormKitProvider, FormKitSummary } from "@formkit/vue";
    ...
    await props.gsSave(
      ...
      (result: any) => {
        if (result === false) {
          ...
          Notification.success("Save FormKitSummary successfully: " + result.id);
        }
      }
    );
  }
